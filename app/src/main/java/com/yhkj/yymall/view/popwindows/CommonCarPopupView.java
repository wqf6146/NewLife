...
/**
 */
public class CommonCarPopupView extends BasePopupWindow {
    ...
    public CommonCarPopupView(Activity context, OnShopCarResLisiten onShopCarResLisiten, ShopDetailsBean.DataBean dataBean, Integer type) {
        this(context,onShopCarResLisiten,dataBean,null,null,null,type);
    }
    public CommonCarPopupView(Activity activity, OnShopCarResLisiten onShopCarResLisiten,
