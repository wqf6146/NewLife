...
public class DiscountPreOrderSettlePresenter extends BaseOrderSettlePresenter {

    BaseOrderSettleView mPreOrderView;

    public DiscountPreOrderSettlePresenter(BaseOrderSettleView preOrderView){
        super(preOrderView);
    ...
    public void getOrderInfo(Boolean bShow,String productId, String nums,String panicBuyId,String groupUserId,
        ...
        YYMallApi.getDiscountPreviewOrder(mPreOrderView.getActivity(),discountId, productId, nums,addressid,bShow,
     ...
     * 提交订单
     */
    public void submitOrder(String addressId, String useYaya, String productId, String nums,
        ...
        YYMallApi.getDiscountOrder(mPreOrderView.getActivity(), discountId,addressId,  productId, nums,hashMap, new YYMallApi.ApiResult<CheckOutOkBean.DataBean>(mPreOrderView.getActivity()) {
            @Override
            public void onStart() {
