...
public class TimekillPreOrderSettlePresenter extends BaseOrderSettlePresenter {

    BaseOrderSettleView mPreOrderView;

    public TimekillPreOrderSettlePresenter(BaseOrderSettleView preOrderView) {
        super(preOrderView);
    ...
    public void getOrderInfo(Boolean bShow,String productId, String nums,String panicBuyId,
        ...
        YYMallApi.getPrewTimekillOrder(mPreOrderView.getActivity(), productId,nums,panicBuyId,addressid,bShow,
     ...
     * 提交订单
     */
    public void submitOrder(String addressId, String useYaya,
                            String productId, String nums,String panicBuyId,String groupUserId,SparseArray delivery,String discountId,String integralId,String dailyId) {
//        mPreOrderView.submitOrderSuccess();
        ...
        YYMallApi.submitTimekillOrder(mPreOrderView.getActivity(),productId,nums, addressId, panicBuyId,hashMap,
