...
public class DailyDetailsActivity extends BaseToolBarActivity implements CommentFragment.OnFinishListen,IWebPageView,DailyCarPopupView.OnShopCarResLisiten {
    ...
    protected void bindEvent() {
        ...
        mLlGetGif.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ShopGiftPopupView shopGiftPopupView = new ShopGiftPopupView(DailyDetailsActivity.this,mDataBean.getId());
        ...
        setImgBackLisiten(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mCurState == 1) {
                    ...
                    AppManager.getInstance().finishActivity(DailyDetailsActivity.this);
            }
        });
        rl_detailsline_point.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WebPopupView webPopupView = new WebPopupView(DailyDetailsActivity.this, ApiService.YYWEB + Constant.WEB_TAG.GET_INT_BY_MALL);
        ...
        rl_detailsline_exp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WebPopupView webPopupView = new WebPopupView(DailyDetailsActivity.this, ApiService.YYWEB + Constant.WEB_TAG.GET_EXP_BY_MALL);
        ...
        mRlBaseServer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                WebPopupView webPopupView = new WebPopupView(DailyDetailsActivity.this, url);
        ...
        mLlCollect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                YYMallApi.addCollectShpp(DailyDetailsActivity.this, new String[]{goodsId}, new YYMallApi.ApiResult<CommonBean>(DailyDetailsActivity.this) {
                    @Override
                    public void onStart() {
        ...
        mRlPopArgs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mDataBean != null) {
                    ShopArgsPopupView shopArgsPopupView = new ShopArgsPopupView<ShopDetailsBean.DataBean.AttrBean>(DailyDetailsActivity.this, mDataBean.getAttr()) {
                        @Override
        ...
        mLlComment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mCurState = 1;
                loadRootFragment(R.id.ald_fl_comment, CommentFragment.getInstance(mDataBean.getId(), -1, null).setOnFinishListen(DailyDetailsActivity.this));
            }
        });
    }
...
//                startActivity(intent);
        ...
        setImgRightLisiten(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DetailsMenuPopupView(DailyDetailsActivity.this).setOnMenuClickLisiten(new DetailsMenuPopupView.OnMenuClickLisiten() {
                    @Override
                    public void onMenuClick(int pos) {
                        if (pos == 1) {
//                            showShareDialog();

                            new ShareAction(DailyDetailsActivity.this)
...
//        startProgress90();
    ...
    public void fullViewAddView(View view) {
        ...
        mFlViewdeoContainer = new FullscreenHolder(DailyDetailsActivity.this);
...
//        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
    ...
    private void getData() {
        YYMallApi.getShopInfo(DailyDetailsActivity.this, goodsId,6,new YYMallApi.ApiResult<ShopDetailsBean.DataBean>(this) {
            @Override
            public void onStart() {
            ...
            public void onError(ApiException e) {
                super.onError(e);
                showToast(e.getMessage());
                if (e.getCode() == 6005 || e.getCode() == 8001 || e.getCode() == 6011) {
...
//                        }
//                    });
                    replaceCustomView(new GoodsGoneLayout(DailyDetailsActivity.this).setLoadLisiten(new GoodsGoneLayout.OnLoadDoneLisiten() {
                        @Override
            ...
            public void onNext(final ShopDetailsBean.DataBean dataBean) {
                ...
                for (int i = 0; i < imgBannerList.size(); i++) {
                    viewList.add(LayoutInflater.from(DailyDetailsActivity.this).inflate(R.layout.view_banner_item, null));
                }
                ...
                tv_detailsline_price.setText("¥" + new java.text.DecimalFormat("#0.00").format(dataBean.getDaily().getPrice()));
...
//                    Glide.with(DailyDetailsActivity.this).load(dataBean.getComment().getList().get(0).getUserico()).placeholder(R.mipmap.ic_nor_srcheadimg).into(img_detailline_useric);
                    Glide.with(DailyDetailsActivity.this).load(dataBean.getComment().getList().get(0).getUserico()).asBitmap().centerCrop().placeholder(R.mipmap.ic_nor_srcheadimg)
                ...
                as_allflowlayouts.setOnTagClickListener(new TagFlowLayout.OnTagClickListener() {
                    ...
                    public boolean onTagClick(View view, int position, FlowLayout parent) {
                        ...
                        setImgRightVisiable(View.INVISIBLE);
                        mCurState = 1;
                        loadRootFragment(R.id.ald_fl_comment, CommentFragment.getInstance(mDataBean.getId(), mTagSelect, (Integer) view.getTag()).setOnFinishListen(DailyDetailsActivity.this));
                        return true;
                    }
                });
...
//                            return;
//                        }
//                        new CommonShopDetailsPopupView(DailyDetailsActivity.this, dataBean, goodsId,true).showPopupWindow();
                    }
                });
...
//                        new CommonShopDetailsPopupView(DailyDetailsActivity.this, dataBean, goodsId,false).showPopupWindow();
                    }
                });
    ...
    protected void initView() {
        ...
        yvp_detailsline.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                WindowManager wm = (WindowManager) DailyDetailsActivity.this
    ...
    class PagerAdapters extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            viewLists.get(position).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(DailyDetailsActivity.this, ShopBannerActivity.class);
...
//            showToast("取消分享");
    ...
    private void showSelectCarPop(Integer type){
        ...
        if (mDataBean == null) return;
        DailyCarPopupView carPopupView;
        if (mSelectSpecHashMap == null)
            carPopupView = new DailyCarPopupView(DailyDetailsActivity.this,DailyDetailsActivity.this,mDataBean,type);
        else
            carPopupView = new DailyCarPopupView(DailyDetailsActivity.this,DailyDetailsActivity.this,mDataBean,mSelectSpecHashMap,mSelectSpecPosHashMap,String.valueOf(mSelectNumb),type);
