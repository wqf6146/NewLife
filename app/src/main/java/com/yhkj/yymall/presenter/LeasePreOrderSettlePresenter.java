...
public class LeasePreOrderSettlePresenter extends BaseOrderSettlePresenter {

    BaseOrderSettleView mPreOrderView;

    public LeasePreOrderSettlePresenter(BaseOrderSettleView preOrderView){
        super(preOrderView);
     ...
     * 获取订单信息
     */
    public void getOrderInfo(Boolean bShow,String productId, String nums,
                             String panicBuyId,String groupUserId,Integer addressid,String discountId,String integralId,String dailyId){
        YYMallApi.getLeasePreviewOrder(mPreOrderView.getActivity(), productId, nums,addressid,bShow,new YYMallApi.ApiResult<CheckOutBean.DataBean>(mPreOrderView.getActivity()) {
            @Override
            public void onStart() {
    ...
    public void submitOrder(String addressId, String useYaya, String productId,
                            String nums,String panicBuyId,String groupUserId,SparseArray delivery,String discountId,String integralId,String dailyId){
        ...
        YYMallApi.getLeaseOrder(mPreOrderView.getActivity(), addressId, useYaya + "", productId, nums,hashMap, new YYMallApi.ApiResult<CheckOutOkBean.DataBean>(mPreOrderView.getActivity()) {
            @Override
            public void onStart() {
