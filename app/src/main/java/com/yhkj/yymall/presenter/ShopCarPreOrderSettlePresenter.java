...
public class ShopCarPreOrderSettlePresenter extends BaseOrderSettlePresenter {

    BaseOrderSettleView mPreOrderView;

    public ShopCarPreOrderSettlePresenter(BaseOrderSettleView preOrderView) {
        super(preOrderView);
    ...
    public void getOrderInfo(Boolean bShow,String productId, String nums,
        ...
        YYMallApi.getLookIndent(mPreOrderView.getActivity(),addressid,bShow, new YYMallApi.ApiResult< CheckOutBean.DataBean>(mPreOrderView.getActivity()) {
            @Override
            public void onStart() {
...
//        mPreOrderView.submitOrderSuccess();
        ...
        YYMallApi.getOrderSubmit(mPreOrderView.getActivity(), addressId, String.valueOf(useYaya),hashMap,
