...
public class DailyPreOrderSettlePresenter extends BaseOrderSettlePresenter {

    BaseOrderSettleView mPreOrderView;

    public DailyPreOrderSettlePresenter(BaseOrderSettleView preOrderView){
        super(preOrderView);
    ...
    public void getOrderInfo(Boolean bShow,String productId, String nums,String panicBuyId,String groupUserId,Integer addressid,
        ...
        YYMallApi.getDailyPreviewOrder(mPreOrderView.getActivity(),dailyId, productId, nums,addressid,bShow,
     ...
     * 提交订单
     */
    public void submitOrder(String addressId, String useYaya, String productId, String nums,String panicBuyId,String groupUserId,SparseArray delivery,
                            String discountId,String integralId,String dailyId){
        ...
        YYMallApi.getDailyOrder(mPreOrderView.getActivity(), dailyId,addressId,  productId, nums,hashMap, new YYMallApi.ApiResult<CheckOutOkBean.DataBean>(mPreOrderView.getActivity()) {
            @Override
            public void onStart() {
