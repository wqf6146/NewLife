...
public class CommonPreOrderSettlePresenter extends BaseOrderSettlePresenter {

    BaseOrderSettleView mPreOrderView;

    public CommonPreOrderSettlePresenter(BaseOrderSettleView preOrderView){
        super(preOrderView);
     ...
     * 获取订单信息
     */
    public void getOrderInfo(Boolean bShow,String productId, String nums, String panicBuyId, String groupUserId,
                             Integer addressid,String discountId,String integralId,String dailyId){
        YYMallApi.getOneLookOrder(mPreOrderView.getActivity(), productId, nums, addressid,bShow,new YYMallApi.ApiResult<CheckOutBean.DataBean>(mPreOrderView.getActivity()) {
            @Override
            public void onStart() {
     ...
     * 提交订单
     */
    public void submitOrder(String addressId, String useYaya, String productId, String nums,String panicBuyId,
                            String groupUserId, SparseArray delivery,String discountId,String integralId,String dailyId){
//        mPreOrderView.submitOrderSuccess();
        ...
        YYMallApi.getOneCreateOrder(mPreOrderView.getActivity(), addressId, useYaya + "", productId, nums,hashMap,
