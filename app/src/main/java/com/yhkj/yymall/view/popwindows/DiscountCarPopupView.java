...
/**
 */
public class DiscountCarPopupView extends BasePopupWindow {
    ...
    public DiscountCarPopupView(Activity context, OnShopCarResLisiten onShopCarResLisiten, ShopDetailsBean.DataBean dataBean, Integer type) {
        this(context,onShopCarResLisiten,dataBean,null,null,null,type);
    }
    public DiscountCarPopupView(Activity activity, OnShopCarResLisiten onShopCarResLisiten,
