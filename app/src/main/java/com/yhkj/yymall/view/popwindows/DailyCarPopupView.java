...
/**
 */
public class DailyCarPopupView extends BasePopupWindow {
    ...
    public DailyCarPopupView(Activity context, OnShopCarResLisiten onShopCarResLisiten, ShopDetailsBean.DataBean dataBean, Integer type) {
        this(context,onShopCarResLisiten,dataBean,null,null,null,type);
    }
    public DailyCarPopupView(Activity activity, OnShopCarResLisiten onShopCarResLisiten,
