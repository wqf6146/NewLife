...
/**
 */
public class GroupCarPopupView extends BasePopupWindow {
    ...
    public GroupCarPopupView(Activity context, OnShopCarResLisiten onShopCarResLisiten, ShopDetailsBean.DataBean dataBean, Integer type) {
        this(context,onShopCarResLisiten,dataBean,null,null,null,type);
    }
    public GroupCarPopupView(Activity activity, OnShopCarResLisiten onShopCarResLisiten,
    ...
    private void setBottomShow(){
        if (mType == null){
            ...
            mTvCopyRight.setText(mDataBean.getGroup().getAllowNum() + "人团");
            return;
        }else{
            switch (mType){
                case 0:
