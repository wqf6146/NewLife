...
public class GrouponPreOrderSettlePresenter extends BaseOrderSettlePresenter {

    BaseOrderSettleView mPreOrderView;

    public GrouponPreOrderSettlePresenter(BaseOrderSettleView preOrderView) {
        super(preOrderView);
    ...
    public void getOrderInfo(Boolean bShow,String productId, String nums, String panicBuyId,
        ...
        YYMallApi.getOrderPreviewGroupBuy(mPreOrderView.getActivity(), groupUserId, nums, productId,addressid ,bShow,new ApiCallback<CheckOutBean.DataBean>() {
            @Override
            public void onStart() {
...
//        mPreOrderView.submitOrderSuccess();
        ...
        YYMallApi.getOrderSubmitGroupBuy(mPreOrderView.getActivity(),  groupUserId,addressId, nums, productId, hashMap,
