package com.yhkj.yymall.view.flowlayout;
...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener
{
    ...
    // 默认0、全显示-1
    private int mMaxShowItem = -1;

    public void setMaxShowItem(int maxShowItem){
        mMaxShowItem = maxShowItem;
    }
    ...
    private void changeAdapter()
    {
        ...
        int maxshow = mMaxShowItem > 0 ? (mMaxShowItem > adapter.getCount() ? adapter.getCount() : mMaxShowItem ) : adapter.getCount();
