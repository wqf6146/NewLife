package com.yhkj.yymall.view.nestpager;
...
public class Page extends NestedScrollView {
    ...
    private OnPageStatusChange mOnPageStatusChange;

    public void setPageStatus(int status){
        if (mOnPageStatusChange!=null){
            mOnPageStatusChange.onPageStatusChange(status);
        }
    }

    public void setOnPageStatusChange(OnPageStatusChange onPageStatusChange) {
        this.mOnPageStatusChange = onPageStatusChange;
    }

    public interface OnPageStatusChange{
        void onPageStatusChange(int status);
    }
}
